...
export const MentorData: { profession: string; name: string; imgSrc: string }[] = [
  {
    ...
    name: 'Sphesihle Shozi',
    imgSrc: '/images/mentor/user3.png',
  },
  {
    profession: 'Buhle Langa',
    name: 'Oparations Manager',
...
export const TestimonialData: { profession: string; comment: string; imgSrc: string; name: string; rating: number; }[] = [
  {
    name: "Buhle Langa",
    profession: 'Oparations Manager',
    comment: 'A dedicated advocate for youth development, bringing expertise in curriculum design and learner engagement',
    imgSrc: '/images/mentor/user2.png',
    rating: 5
  },
  {
